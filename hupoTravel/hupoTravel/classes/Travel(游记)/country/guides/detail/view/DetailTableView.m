...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    ...
    UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(55, 10, 260, 20)];
    DetailLayout *layout = (DetailLayout *)self.modelArray[section];
    label.text = layout.detailModel.topic;
    label.font = [UIFont systemFontOfSize:13];
    [view addSubview:label];
    
    UIButton *likeButton = [[UIButton alloc] initWithFrame:CGRectMake(kScreenWidth - 30, 10, 20, 20)];
